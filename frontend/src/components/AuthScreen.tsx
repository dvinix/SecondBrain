    ...
    <div className="relative min-h-screen flex items-center justify-center bg-background px-4">
      ...
      <div className="w-full max-w-md z-10 glass-strong rounded-2xl shadow-elegant overflow-hidden">
        ...
        <div className="flex items-center gap-1.5 px-4 py-3 border-b border-border bg-black/10">
          ...
          <div className="h-2.5 w-2.5 rounded-full bg-white/10" />
          <div className="h-2.5 w-2.5 rounded-full bg-white/10" />
          <div className="ml-3 text-[11px] text-muted-foreground font-['Inter']">secondbrain / auth</div>
        </div>

        <div className="p-8 sm:p-10 space-y-8 bg-zinc-900/30">
          <div className="flex flex-col items-center">
            <div className="relative h-16 w-16 rounded-2xl bg-gradient-to-br from-primary to-secondary grid place-items-center glow-primary mb-6 shadow-inner">
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-4">
            ...
            <div className="flex items-center gap-4 py-2">
              ...
              <span className="text-xs text-zinc-500 uppercase tracking-wider font-semibold font-['Inter']">Or continue with</span>
              <div className="flex-1 h-px bg-white/10"></div>
            </div>
            ...
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-3 py-4 px-4 rounded-xl text-sm font-semibold bg-white text-black hover:bg-zinc-200 transition-all active:scale-[0.98] font-['Sora'] shadow-sm disabled:opacity-50"
            >
